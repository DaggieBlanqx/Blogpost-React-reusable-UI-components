  ...
  return (
    <>
      ...
      <FormWrapper onSubmit={formTwoSubmitter} title="Form Two">
        ...
        />
        &nbsp;
        <Button type="reset" variant="warning" size={"sm"} >Clear Form</Button>
        {formTwoSearch && (<p>Searching for "<b>{formTwoSearch}</b>"</p>)}
      </FormWrapper>
      ...
      <>
        ...
        >
          ...
          <p>Here's how to use functional components & hooks (e.g useState, useRef etc) to create reusable components.
            </p>
          <Button>
